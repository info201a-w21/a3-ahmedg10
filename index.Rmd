...
ui <- navbarPage (
 ...
 tabPanel(
    titlePanel("Introduction to Data"),
    h1("Introduction"),
    mainPanel(
      p("I am going to evaluate and work with Our World in Data's dataset on CO2 
        and Greenhouse Gas emissions that are present in our world. 
        The data presents the CO2 and Gas Emissions data from 1750 to 2019. 
        Earth has reached a point in which climate change is happening more 
        rapidly then ever. The primary cause is due is the amount of build up of 
        CO2 and Greenhouses that are released into our planet. This data set 
        from World in Data will allow us to better evaluate and explore the 
        C02 and greenhouse emission in our world over time. "),
